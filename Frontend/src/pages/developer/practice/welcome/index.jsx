...
const Welcome = () =>{
  ...
  const handleScroll = (e) =>{
    if(window.pageYOffset<document.documentElement.offsetHeight*1.5&&window.pageYOffset>document.documentElement.offsetHeight*0.5)
    setPage(1)
    if(window.pageYOffset>document.documentElement.offsetHeight*1.5)
    setPage(2)
  ...
  <div className={styles.body} >
    ...
    <div id="p3" key='2' className={styles.page}>
      <div className={styles.three}>
        <Button href="/developer/practice">practice3</Button>
      </div>
    </div>
    <div className={styles.thumbs}>
    <AnchorLink href="#p1" onClick={()=>{
      setPage(0)
    }}><div className={styles.thumb} style={page==0?{backgroundColor:'white'}:null}></div></AnchorLink>
    <AnchorLink href="#p2" onClick={()=>{
      setPage(1)
    }}><div className={styles.thumb} style={page==1?{backgroundColor:'white'}:null}></div></AnchorLink>
    <AnchorLink href="#p3" onClick={()=>{
      setPage(2)
    }}><div className={styles.thumb} style={page==2?{backgroundColor:'white'}:null}></div></AnchorLink>
    </div>
  </div>
</div>
    </>
